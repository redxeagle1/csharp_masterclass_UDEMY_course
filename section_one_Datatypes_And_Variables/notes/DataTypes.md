...
- Typically stored in the stack <mark style="background-color: rgba(255, 235, 59, 0.4);color: #d4dfe7;">meaning they allocation and deacllocation are managed automatically as the program grows</mark>
